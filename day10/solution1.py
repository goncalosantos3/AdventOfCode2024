...
def calculateScoresSum(trails, trailHeads):
    ...
    for head in trailHeads:
        headScore = trailHeadScore(0, head, trails, set())
        score += headScore
